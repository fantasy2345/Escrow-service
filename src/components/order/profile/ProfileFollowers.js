    ...
    <Card sx={{ display: 'flex', alignItems: 'center', p: 3 }}>
      ...
      <Box sx={{ flexGrow: 1, minWidth: 0, pl: 2, pr: 1 }}>
        ...
        <Box sx={{ display: 'flex', alignItems: 'center' }}>
          ...
          />
          <Typography component={'span'} component={'span'} variant="body2" sx={{ color: 'text.secondary' }} noWrap>
            {country}
          </Typography>
        </Box>
      </Box>
...
export default function ProfileFollowers({ followers, onToggleFollow, sx }) {
  return (
    <Box sx={{ mt: 5, ...sx }}>
      <Typography component={'span'} variant="h4" sx={{ mb: 3 }}>
        Followers
      </Typography>
