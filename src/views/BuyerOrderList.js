...
let TABLE_HEAD = [
  ...
  { id: 'or_sellerEmail', label: 'Seller Email', alignRight: false },
  ...
  if (query) {
    return filter(array, (_user) => {
      if (_user.or_topic != null) {
        return (
          _user.or_topic.toLowerCase().indexOf(query.toLowerCase()) !== -1
        );
      } else {
        return false;
      }
...
export default function orderList() {
  ...
  if (user.role === 0) {
    ...
    useEffect(() => {
      dispatch(getOrderList(user.role));
    }, [dispatch]);
  }
                ...
                <TableBody>
                  {filteredUsers
                    ...
                    .map((row) => {
                      ...
                      const isItemSelected = selected != null && selected.indexOf(id) !== -1;
                      return (
                        <TableRow
                          hover
                          key={id}
                        ...
                        >
                          ...
                          <TableCell align="left">{or_sellerEmail}</TableCell>
                          <TableCell align="left">
                            <Label
                              variant={
